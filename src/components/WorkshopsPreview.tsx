...
const WorkshopsPreview = () => {
  ...
  return <section id="workshops" className="section-padding relative bg-dark-gray">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {workshops.map(workshop => <div key={workshop.id} className={`cyber-card relative overflow-hidden ${workshop.color === 'cyber-blue' ? '' : workshop.color === 'cyber-green' ? 'cyber-card-green' : 'cyber-card-purple'}`} onMouseEnter={() => handleCardHover(workshop.id)} onMouseLeave={() => setActiveCard(null)}>
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex justify-center gap-4">
            ...
            <div className="cyber-card p-3 w-20">
              ...
              <div className="text-gray-400 text-3xl">Challenges Will Be Revealed On:</div>
            </div>
            <div className="cyber-card p-3 w-20">
